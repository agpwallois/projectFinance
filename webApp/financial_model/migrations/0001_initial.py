# Generated by Django 4.2 on 2025-07-31 07:27

import datetime
from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import financial_model.model_fm
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financial_model', models.JSONField(default=dict, encoder=financial_model.model_fm.CustomJSONEncoder)),
                ('model_type', models.CharField(default='default-identifier', max_length=255)),
                ('sensitivity', models.CharField(default='default-identifier', max_length=255)),
                ...
                ('depends_on', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dependent_models', to='financial_model.financialmodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensi_production_sponsor', models.DecimalField(decimal_places=0, default=0, max_digits=3)),
                ('sensi_opex_sponsor', models.DecimalField(decimal_places=0, default=10, max_digits=3)),
                ('sensi_inflation_sponsor', models.DecimalField(decimal_places=0, default=1, max_digits=3)),
                ...
                ('sponsor_irr', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('valuation', models.DecimalField(decimal_places=0, default=0, max_digits=4)),
                ('company', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='authentication.company')),
