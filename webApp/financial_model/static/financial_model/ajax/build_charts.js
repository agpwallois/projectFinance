...
function updateChartsAnnual(json) {
        ...
        chartDebtS.data.datasets[0].data = Object.values(json.df_annual['senior_debt']['interests_operations']);
        chartDebtS.data.datasets[1].data = Object.values(json.df_annual['senior_debt']['repayments']);
